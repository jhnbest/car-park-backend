...
var buffer_1 = require("../buffer"), error_1 = require("../../driver/error"), const_1 = require("../../desc/const"), events_1 = require("events"), timer_1 = require("../../utils/timer"), svcConf_1 = require("../../desc/svcConf"), Msg = function(_) {
    ...
    return __extends(M, _), M.prototype.Kt = function() {
        ...
        if (this.fs = this.St.s(M.Rs), this.fs < 0) {
            if (this.fs !== error_1.DBError.EC_RN_EXCEED_ROWSET_SIZE().errCode) throw new error_1.DBError(this.fs, (this.br.pt.rwStandby ? "[S] " : "") + this.ws());
        ...
        var t, s;
        this.br.dt ? (t = this.Rt(), this.Et(t + M.Us), s = this.Ns(this.St, 0, M.kt + t), 
        this.St.k(s)) : this.St.$n(M.qs, this.Bs(this.St));
    }, M.prototype.Bt = function() {
        if (this.br.dt) {
            var t = this.Rt() - M.Us, s = M.kt + t;
            if (this.St.s(s) !== this.Ns(this.St, 0, s)) throw error_1.DBError.ECJS_MSG_CHECK_ERROR();
            this.Et(t), this.St.Tt(s);
        } else {
            if (this.St.H(M.qs) !== this.Bs(this.St)) throw error_1.DBError.ECJS_MSG_CHECK_ERROR();
        }
    }, M.prototype.Bs = function(t) {
        for (var s = t.H(0), i = 1; i < M.qs; i++) s ^= t.H(i);
        return s;
    }, M.prototype.Ns = function(t, s, i) {
        for (var n = 4294967295, r = s, _ = i - s; 8 <= _; ) {
            var h = t.s(r) ^ n;
            r += const_1.Const.ULINT_SIZE;
            var e = t.s(r);
            r += const_1.Const.ULINT_SIZE, n = M.Gs[7][255 & h] ^ M.Gs[6][h >> 8 & 255] ^ M.Gs[5][h >> 16 & 255] ^ M.Gs[4][h >> 24 & 255] ^ M.Gs[3][255 & e] ^ M.Gs[2][e >> 8 & 255] ^ M.Gs[1][e >> 16 & 255] ^ M.Gs[0][e >> 24 & 255], 
            _ -= 8;
        }
        for (;0 < _; ) n = n >> 8 & 16777215 ^ M.Gs[0][255 & n ^ t.H(r)], r++, _--;
        return ~n;
