...
var __awaiter = this && this.__awaiter || function(t, o, h, u) {
            ...
            return function(i) {
                ...
                for (;h; ) try {
                    ...
                    switch (s = 0, o && (i = [ 2 & i[0], o.value ]), i[0]) {
                      ...
                      default:
                        if (!(o = 0 < (o = h.trys).length && o[o.length - 1]) && (6 === i[0] || 2 === i[0])) {
                            h = 0;
                            continue;
                        }
...
var const_1 = require("../desc/const"), logMiddleware_1 = require("./log/logMiddleware"), svcConf_1 = require("../desc/svcConf"), rwMiddleware_1 = require("./rw/rwMiddleware"), reconnectMiddleware_1 = require("./reconnect/reconnectMiddleware"), Middlewares = function() {
    ...
    return t.prototype.createMiddleWares = function(t, i) {
        ...
        this.recoverInfo = new RecoverInfo()), 0 < t.conn_prop_rwSeparate && (r.push(rwMiddleware_1.RWMiddleware.getInstance(t.conn_prop_rwSeparate)), 
        ...
        this.recoverInfo = new RecoverInfo()), 0 < i.getNumber("rwSeparate", 0) && (r.push(rwMiddleware_1.RWMiddleware.getInstance(i.getNumber("rwSeparate", 0))), 
    ...
    }, t.prototype.connection_free = function(i) {
        return __awaiter(this, void 0, void 0, function() {
            return __generator(this, function(t) {
                return this.pos < this.middlewares.length ? [ 2, this.middlewares[this.pos++].connection_free(this, i) ] : [ 2, i.do_free() ];
            });
        });
...
var RWInfo = function() {
    ...
    }, t.prototype.toStandby = function() {
        return this.distribute !== RWSiteEnum.STANDBY && this.rwCounter.countStandby(), 
        this.distribute = RWSiteEnum.STANDBY, this.distribute;
